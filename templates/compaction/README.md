...
cp .hek/kit/compaction/round-contract.md .claude/round-contract.md
cp .hek/kit/compaction/save-state.sh .claude/hooks/save-state.sh
...
cp .hek/kit/compaction/codex-round-contract.md .codex/round-contract.md
cp .hek/kit/compaction/codex-save-state.sh .codex/hooks/save-state.sh
